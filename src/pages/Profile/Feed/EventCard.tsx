...
export default function EventCard() {
  return (
    <Card border="2px solid black" borderRadius="15px" overflow="hidden">
      ...
      <CardBody pt="5px">
        <Heading pb="10pxs" fontSize="28px">
          Paradise Ibiza
        </Heading>
        <Text fontSize="14px">
          ...
          jaguar’s ‘spirit of the midnight sun’. In ancient prophecies the
          jaguar is seen as a guide for those who journey into the night
          surrounded by the primal energy of the jungle.
          <br />
          <br />
          And so it goes, until the first glimmers of dawn begin to light the
          sky. The jaguar fades back into the shadows, but it&apos;s fierce and
          untamed spirit remains until the next rising of the midnight sun when
          we dance again for Night of The Jaguar. Join Jamie Jones plus a host
          of artists soon to be announced for Paradise every Wednesday at
          Amnesia.
        </Text>
        <Box pt="20px" pb="10px">
          <Button
